...
function App() {
  ...
  const Layout = ({ children }) => {
    ...
    const [noShowNavbarLocations, setNoShowNavbarLocations] = useState(["/user-signin", "/admin-signin", "/admin-confirm-email", "/user-signup", "user-mangement", '/user-registration', '/confirm-user','/new-user/reset-password']);

...
import { admin_create_new_user, validate_username } from '../../services/user_info_service';
import { debounce } from '../util/debounce';
import { validate_email } from '../../services/user_info_service';
...
const UserModal: React.FC<UserModalProps> = ({ isOpen, onClose }) => {
    ...
    const checkUsernameAvailability = async (newUsername) => {
        ...
        const response = await validate_username(trimmedUsername);
    ...
    const checkEmailAvailability = async (newEmail) => {
        ...
        const response = await validate_email(trimmedEmail);
        if (response === false) {
    ...
    const debouncedCheckUsername = React.useCallback(debounce((newUsername) => {
    ...
    const handleCreateNewUser = async () => {
        ...
        const response = await admin_create_new_user(newUser);

...
interface EditUserModalProps {
    user: User;
    isOpen: boolean;
    onClose: (arg0: boolean, arg1: User) => void;
}
        ...
        <div className='modal-body'>
            ...
            <div className="flex flex-row gap-2 content-center justify-start w-full pt-4">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <select id="role" name="role" value={newUser.role} onChange={(e) => setNewUser({ ...newUser, role: e.target.value })}>
            ...
            <div className="flex flex-row items-center justify-center gap-2 w-full mt-8">
                ...
                <div className="flex flex-row items-center justify-center gap-2 flex-grow">
                    <button className="centered-button" onClick={() => onClose(false, newUser)}>
                        Cancel
                    </button>
